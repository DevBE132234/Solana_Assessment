...
const endpoint = 'https://nameless-falling-spring.solana-devnet.discover.quiknode.pro/3bfaa55c7dafaf2acc5ff99fe1ccaa731d0b6b7c/'; //Replace with your RPC Endpoint
const solanaConnection = new Connection(endpoint);

//token configuration number of decimals and token to mint
const MINT_CONFIG = {
    numDecimals: 6,
    numberTokens: 1337
}
...
const MY_TOKEN_METADATA: UploadMetadataInput = {
    ...
    image: "https://www.cleanpng.com/png-cancer-astrological-sign-zodiac-astrology-astrolog-2070574/preview.html" //add public URL to image you'd like to use
}
